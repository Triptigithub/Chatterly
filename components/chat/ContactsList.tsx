      ...
      >
        {permissionError ? (
          ...
          displayedContacts.map((contact) => (
            ...
            >
              <UserContact
                displayLabel={contact.username}
                recentMsg={contact.latestMessage || "Send new message"}
                contactInfo={contact.phone || ""}
                msgCount={contact.unreadCount}
                timestamp={contact.lastMessageDate || ""}
                profilePic={contact.avatar_url || undefined}
                deliveryFlag={contact.userSentState}
                highlight={selectedContact?.id === contact.id}
              />
            </div>
          ))
        ) : (
